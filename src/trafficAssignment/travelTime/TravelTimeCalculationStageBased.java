...
public class TravelTimeCalculationStageBased 
{
	//~Variables
	//--------------------------------------------------------------------------
	...
	private StagebasedSignalTiming signalTiming=null;
	...
	//~Methods
	//--------------------------------------------------------------------------
	public TravelTimeCalculationStageBased(Network network,IloCplex cplex)
	{
...
//					armLanesNum,armDirNum,outLanesNum,extLinks);
			...
			signalTiming.solveMe(modFoesMatrix, junc.getMarkerList(), fixedDemandForSignal, armNumber, armDir,
